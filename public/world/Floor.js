...
export class Floor extends Entity {
    constructor(x, y, type = 'GRASS', options = {}) {
        ...
        if (['MAISON_ORANGE', 'MAISON_BLEU', 'MAISON_VIOLETTE'].includes(type)) srcSize = 48;   
        ...
        const marWalkable = ['MAR_PONT_2', 'MAR_SOUCHE', 'MAR_CHAMPI', 'MAR_PONT_4', 'MAR_BOIS_3', 'MAR_PLANCHE_3', 'MAR_BOIS_2', 'MAR_MARECAGE_8', 'MAR_EXTRA_1', 'MAR_TROU', 'MAR_MARECAGE_6', 'MAR_PLANCHE_1', 'MAR_BOIS_4', 'MAR_SORTIE', 'MAR_MARECAGE_10'];
    ...
    draw(ctx) {
        ...
        if (this.type.startsWith('MAR_')) {
            ...
            const marMapping = {
                ...
                'MAR_CHEMIN_HD': { sx: 0, sy: 32 }, 'MAR_MARECAGE_3': { sx: 16, sy: 32 }, 'MAR_MARECAGE_4': { sx: 32, sy: 32 }, 'MAR_PONT_3': { sx: 48, sy: 32 }, 'MAR_PONT_4': { sx: 64, sy: 32 }, 'MAR_TROU': { sx: 80, sy: 32 }, 'MAR_SORTIE': { sx: 96, sy: 32 }, 'MAR_BOUE_4': { sx: 112, sy: 32 }, 'MAR_EAU_TEAL_2': { sx: 128, sy: 32 }, 'MAR_SOMBRE_5': { sx: 144, sy: 32 }, 'MAR_EXTRA_3': { sx: 160, sy: 32 },
