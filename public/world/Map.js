// Gestionnaire de niveau : charge les donnees de carte et genere les entites de decor
...
export class Map extends Entity {
    ...
    load(mapData) {
        ...
        mapData.walls.forEach(tile => {
            ...
            // Maisons : desactivent le collider principal et ajoutent des murs invisibles autour
